import {
  parse
} from "./chunk-JHXK7JRH.js";
import {
  DeferredPromise2 as DeferredPromise,
  Disposable,
  Emitter,
  FetchResponse,
  HttpResponse,
...
var HttpHandler = class extends RequestHandler {
  ...
  async parse(args) {
    ...
    const match = this.info.path ? matchRequestUrl(url, this.info.path, (_a3 = args.resolutionContext) == null ? void 0 : _a3.baseUrl) : { matches: false, params: {} };
    return {
      match,
      cookies
    };
...
async function parseQuery(query) {
  const { parse: parse3 } = await import("./graphql-7L7VNNXE.js").catch((error) => {
...
var _GraphQLHandler = class _GraphQLHandler extends RequestHandler {
  constructor(operationType, predicate, endpoint, resolver, options) {
    var _a3, _b2;
    const operationName = __privateMethod(_a3 = _GraphQLHandler, _GraphQLHandler_static, parseOperationName_fn).call(_a3, predicate, operationType);
...
function createWebSocketLinkHandler(url) {
  ...
  const upgradeHandler = http.get(({ request }) => {
    var _a3;
    return ((_a3 = request.headers.get("upgrade")) == null ? void 0 : _a3.toLowerCase()) === "websocket" && matchRequestUrl(new URL(resolveWebSocketUrl(request.url)), url).matches;
  }, ws.onUpgrade);
  return {
    get clients() {
...
var _loggableRequests, _ServerSentEventHandler_instances, attachClientLogger_fn;
var ServerSentEventHandler = class extends HttpHandler {
  constructor(path, resolver) {
    ...
    super("GET", path, async (info) => {
      ...
      if (__privateGet(this, _loggableRequests).has(info.request)) {
        __privateMethod(this, _ServerSentEventHandler_instances, attachClientLogger_fn).call(this, info.request, emitter);
      }
      await resolver(
        Object.assign(info, {
          client,
    ...
    __privateAdd(this, _loggableRequests);
    __privateSet(this, _loggableRequests, /* @__PURE__ */ new WeakSet());
  }
  async predicate(args) {
    var _a3;
    ...
    if (matches && !((_a3 = args.resolutionContext) == null ? void 0 : _a3.quiet)) {
      await super.log({
        request: args.request,
        /**
      ...
      __privateGet(this, _loggableRequests).add(args.request);
    }
    return matches;
  }
  async log(args) {
    var _a3;
    (_a3 = args.response.body) == null ? void 0 : _a3.cancel();
    return;
  }
};
_loggableRequests = new WeakMap();
...
var _a, _encoder, _controller, _closed, _ServerSentEventClient_instances, enqueue_fn, sendRetry_fn, sendMessage_fn;
_a = kClientEmitter;
var ServerSentEventClient = class {
  constructor(controller) {
    ...
    __privateSet(this, _closed, new DeferredPromise());
  }
  /**
  ...
  error() {
    var _a3;
    if (__privateGet(this, _closed).state !== "pending") {
      return;
    }
    __privateGet(this, _controller).error();
    __privateGet(this, _closed).resolve();
    (_a3 = this[kClientEmitter]) == null ? void 0 : _a3.emit(new TypedEvent("error"));
  }
  /**
  ...
  close() {
    ...
    (_a3 = this[kClientEmitter]) == null ? void 0 : _a3.emit(new TypedEvent("close"));
  }
};
...
enqueue_fn = function(chunk) {
  if (__privateGet(this, _closed).state !== "pending") {
    return;
  }
  try {
    __privateGet(this, _controller).enqueue(chunk);
  } catch (error) {
    console.error(error);
    devUtils.error(
...
sendRetry_fn = function(retry) {
  __privateMethod(this, _ServerSentEventClient_instances, enqueue_fn).call(this, __privateGet(this, _encoder).encode(`retry:${retry}
...
sendMessage_fn = function(message2) {
  ...
  frames.push("", "");
  __privateMethod(this, _ServerSentEventClient_instances, enqueue_fn).call(this, __privateGet(this, _encoder).encode(frames.join("\n")));
  (_b2 = this[kClientEmitter]) == null ? void 0 : _b2.emit(
    new TypedEvent("message", {
      data: {
        id: message2.id,
        event: ((_a3 = message2.event) == null ? void 0 : _a3.toString()) || "message",
        data: message2.data,
        frames
      }
    })
  ...
  interpretResponseBody(response) {
    const parsingStream = new EventSourceParsingStream({
      message: (message2) => {
        ...
        (_a3 = this[kOnAnyMessage]) == null ? void 0 : _a3.call(this, messageEvent);
...
var EventSourceParsingStream = class extends WritableStream {
  constructor(underlyingSink) {
    super({
      ...
      abort: (reason) => {
        var _a3, _b2;
        (_b2 = (_a3 = this.underlyingSink).abort) == null ? void 0 : _b2.call(_a3, reason);
      },
      close: () => {
        var _a3, _b2;
        (_b2 = (_a3 = this.underlyingSink).close) == null ? void 0 : _b2.call(_a3);
      }
    });
    __publicField(this, "underlyingSink");
  ...
  processLine(line, fieldLength) {
    ...
    if (fieldLength > 0) {
      ...
      switch (field) {
        ...
        case "retry": {
          if (/^\d+$/.test(value)) {
            (_b2 = (_a3 = this.underlyingSink).retry) == null ? void 0 : _b2.call(_a3, parseInt(value, 10));
          }
          break;
        }
      }
