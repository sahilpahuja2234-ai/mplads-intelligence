...
function shouldBypassRequest(request) {
  var _a22;
  return !!((_a22 = request.headers.get("accept")) == null ? void 0 : _a22.includes("msw/passthrough"));
}
  ...
  async resolve(handlers, onUnhandledFrame, resolutionContext) {
    ...
    const [lookupError, lookupResult] = await until(() => {
      ...
      return executeHandlers({
        ...
        handlers,
        resolutionContext: {
          baseUrl: (_a22 = resolutionContext == null ? void 0 : resolutionContext.baseUrl) == null ? void 0 : _a22.toString(),
  ...
  */
  send(data) {
    ...
    queueMicrotask(() => {
      var _a22;
      this.bufferedAmount = 0;
      (_a22 = this[kOnSend]) == null ? void 0 : _a22.call(this, data);
    });
  }
...
function getVariable(variableName) {
  ...
  return (_a22 = globalThis[variableName]) == null ? void 0 : _a22.toString();
}
...
var Interceptor2 = class {
  ...
  */
  ...
  getInstance() {
    ...
    this.logger.info("retrieved global instance:", (_a22 = instance == null ? void 0 : instance.constructor) == null ? void 0 : _a22.name);
    return instance;
  }
  setInstance() {
...
var _replacements2, _a4;
var PatchesRegistry2 = (_a4 = class {
  constructor() {
    __privateAdd(this, _replacements2, /* @__PURE__ */ new Map());
  }
  applyPatch(owner, key, getNextValue) {
    const ownerReplacements = __privateGet(this, _replacements2).get(owner);
    invariant2(!(ownerReplacements == null ? void 0 : ownerReplacements.has(key)), `Failed to replace a global value at "${String(key)}": already replaced.`);
    const match = getDeepPropertyDescriptor2(owner, key);
    if (typeof match === "undefined") {
      console.warn(`Failed to replace a global value at "${String(key)}": not a global value.`);
      return () => {
      };
    ...
    const restorePatch = () => {
      const currentReplacements = __privateGet(this, _replacements2).get(owner);
      if (!(currentReplacements == null ? void 0 : currentReplacements.has(key))) return;
      if (match.owner === owner)
        Object.defineProperty(match.owner, key, match.descriptor);
      else
        Reflect.deleteProperty(owner, key);
      currentReplacements.delete(key);
      if (currentReplacements.size === 0) __privateGet(this, _replacements2).delete(owner);
    };
    if (ownerReplacements) ownerReplacements.set(key, restorePatch);
    else __privateGet(this, _replacements2).set(owner, /* @__PURE__ */ new Map([[key, restorePatch]]));
    return restorePatch;
  }
  restoreAllPatches() {
    const errors = [];
    for (const [, ownerReplacements] of __privateGet(this, _replacements2)) for (const [, restorePatch] of ownerReplacements) try {
      restorePatch();
    } catch (error2) {
      if (error2 instanceof Error) errors.push(error2);
      else throw error2;
...
}, _replacements2 = new WeakMap(), _a4);
...
function hasConfigurableGlobal2(propertyName) {
  const match = getDeepPropertyDescriptor2(globalThis, propertyName);
  if (typeof match === "undefined") return false;
  const { descriptor } = match;
  if (typeof descriptor.get === "function" && typeof descriptor.get() === "undefined") return false;
  if (typeof descriptor.get === "undefined" && descriptor.value == null) return false;
...
var _executor, _DeferredPromise_instances, decorate_fn, _a5;
var DeferredPromise2 = (_a5 = class extends Promise {
...
var _a6;
var WebSocketOverride2 = (_a6 = class extends EventTarget {
  constructor(url, protocols) {
    super();
    this.CONNECTING = 0;
    this.OPEN = 1;
  ...
  */
  send(data) {
    ...
    queueMicrotask(() => {
      var _a22;
      this.bufferedAmount = 0;
      (_a22 = this[kOnSend2]) == null ? void 0 : _a22.call(this, data);
    });
  }
  close(code = 1e3, reason) {
...
}, _a6.CONNECTING = 0, _a6.OPEN = 1, _a6.CLOSING = 2, _a6.CLOSED = 3, _a6);
...
var _a7;
var WebSocketInterceptor2 = (_a7 = class extends Interceptor2 {
  constructor() {
    super(_a7.symbol);
  }
  checkEnvironment() {
...
}, _a7.symbol = Symbol.for("websocket-interceptor"), _a7);
...
var _executor2, _DeferredPromise2_instances, decorate_fn2, _a8;
var DeferredPromise22 = (_a8 = class extends Promise {
  constructor(executor = null) {
...
var _RequestController2_instances, handled_get, _a9;
var RequestController = (_a9 = class {
  constructor(request, source) {
    __privateAdd(this, _RequestController2_instances);
    this.request = request;
    this.source = source;
    this.readyState = _a9.PENDING;
  ...
  */
  async passthrough() {
    invariant2.as(InterceptorError, this.readyState === _a9.PENDING, 'Failed to passthrough the "%s %s" request: the request has already been handled', this.request.method, this.request.url);
    this.readyState = _a9.PASSTHROUGH;
  ...
  */
  respondWith(response) {
    invariant2.as(InterceptorError, this.readyState === _a9.PENDING, 'Failed to respond to the "%s %s" request with "%d %s": the request has already been handled (%d)', this.request.method, this.request.url, response.status, response.statusText || "OK", this.readyState);
    this.readyState = _a9.RESPONSE;
    __privateGet(this, _RequestController2_instances, handled_get).resolve();
  ...
  */
  errorWith(reason) {
    invariant2.as(InterceptorError, this.readyState === _a9.PENDING, 'Failed to error the "%s %s" request with "%s": the request has already been handled (%d)', this.request.method, this.request.url, reason == null ? void 0 : reason.toString(), this.readyState);
    this.readyState = _a9.ERROR;
    this.source.errorWith(reason);
    __privateGet(this, _RequestController2_instances, handled_get).resolve();
  }
}, _RequestController2_instances = new WeakSet(), handled_get = function() {
  return this.handled;
}, _a9.PENDING = 0, _a9.PASSTHROUGH = 1, _a9.RESPONSE = 2, _a9.ERROR = 3, _a9);
...
var _FetchRequest2_static, _a10, resolveProperty_fn, _FetchRequest2_instances, setInternalProperty_fn;
var FetchRequest = (_a10 = class extends Request {
  constructor(input, init) {
    var _a22, _b2;
    const method = __privateMethod(_a22 = _a10, _FetchRequest2_static, resolveProperty_fn).call(_a22, input, init, "method") || "GET";
    const safeMethod = _a10.isConfigurableMethod(method) ? method : "GET";
    const hasExplicitBody = init != null && "body" in init;
    const bodyInit = !_a10.isMethodWithBody(method) ? { body: void 0 } : hasExplicitBody ? { body: init.body } : {};
    const mode = __privateMethod(_b2 = _a10, _FetchRequest2_static, resolveProperty_fn).call(_b2, input, init, "mode") ?? void 0;
    const safeMode = _a10.isConfigurableMode(mode) ? mode : void 0;
    super(input, {
      ...init || {},
      method: safeMethod,
      mode: safeMode,
      duplex: (init == null ? void 0 : init.duplex) ?? (_a10.isMethodWithBody(method) ? "half" : void 0),
      ...bodyInit
    });
    __privateAdd(this, _FetchRequest2_instances);
    if (method !== safeMethod) __privateMethod(this, _FetchRequest2_instances, setInternalProperty_fn).call(this, "method", method);
    if (method === "CONNECT") {
    ...
    if (mode != null && mode !== safeMode) __privateMethod(this, _FetchRequest2_instances, setInternalProperty_fn).call(this, "mode", mode);
  }
  /**
  ...
  */
  ...
  static isMethodWithBody(method) {
    return method !== "HEAD" && method !== "GET" && _a10.isConfigurableMethod(method);
  }
  /**
...
}, _FetchRequest2_static = new WeakSet(), resolveProperty_fn = function(input, init = {}, key) {
  return init[key] ?? (input instanceof Request ? input[key] : void 0);
}, _FetchRequest2_instances = new WeakSet(), setInternalProperty_fn = function(key, value) {
...
}, __privateAdd(_a10, _FetchRequest2_static), _a10);
var kStatus = Symbol("kStatus");
var kUrl = Symbol("kUrl");
var _a11;
var FetchResponse = (_a11 = class extends Response {
  static isConfigurableStatusCode(status) {
    return status >= 200 && status <= 599;
  }
  static isRedirectResponse(status) {
    return _a11.STATUS_CODES_WITH_REDIRECT.includes(status);
  }
  /**
  ...
  */
  static isResponseWithBody(status) {
    return !_a11.STATUS_CODES_WITHOUT_BODY.includes(status);
  }
  ...
  */
  ...
  constructor(body, init = {}) {
    ...
    const safeStatus = _a11.isConfigurableStatusCode(status) ? status : 200;
    const finalBody = _a11.isResponseWithBody(status) ? body : null;
    super(finalBody, {
      status: safeStatus,
      statusText: init.statusText,
      headers: init.headers
    });
    if (status !== safeStatus) _a11.setStatus(status, this);
    _a11.setUrl(init.url, this);
  }
  clone() {
    const clonedResponse = super.clone();
    const customStatus = Reflect.get(this, kStatus);
    if (customStatus) _a11.setStatus(customStatus, clonedResponse);
    const customUrl = Reflect.get(this, kUrl);
    if (customUrl) _a11.setUrl(customUrl, clonedResponse);
    return clonedResponse;
  }
}, _a11.STATUS_CODES_WITHOUT_BODY = [
  101,
  103,
  204,
  205,
  304
], _a11.STATUS_CODES_WITH_REDIRECT = [
  301,
  302,
  303,
  307,
...
var _list, _lens, _LensList_instances, openLens_fn, _a12;
var LensList = (_a12 = class {
  constructor() {
...
var _a13, _b, _c, _d, _returnType, _e;
var TypedEvent2 = (_e = class extends (_d = MessageEvent, _c = kDefaultPrevented22, _b = kPropagationStopped, _a13 = kImmediatePropagationStopped, _d) {
  constructor(...args) {
    super(args[0], args[1]);
    /**
...
var _listeners, _listenerOptions, _listenerAbortCleanups, _typelessListeners, _hookListeners, _hookListenerOptions, _hookListenerAbortCleanups, _Emitter2_instances, deleteHookListener_fn, deleteListener_fn, addListener_fn, proxyEvent_fn, callListener_fn, matchListeners_fn, isTypelessListener_fn, _a14;
var Emitter22 = (_a14 = class {
  constructor() {
    ...
    this.hooks = {
      on: (hook, callback, options) => {
        var _a22;
        if ((_a22 = options == null ? void 0 : options.signal) == null ? void 0 : _a22.aborted) return;
  ...
  */
  removeAllListeners(type) {
    ...
    if (type == null) {
      ...
      for (const [hookType, hookListener] of [...__privateGet(this, _hookListeners)]) if (!((_a22 = __privateGet(this, _hookListenerOptions).get(hookListener)) == null ? void 0 : _a22.persist)) __privateMethod(this, _Emitter2_instances, deleteHookListener_fn).call(this, hookType, hookListener);
      return;
    }
...
var _workerEvent, _a15;
var WorkerEvent = (_a15 = class extends TypedEvent2 {
...
}, _workerEvent = new WeakMap(), _a15);
var _getWorker, _controller2, _a16;
var WorkerChannel = (_a16 = class extends Emitter22 {
  constructor(options) {
    super();
...
}, _getWorker = new WeakMap(), _controller2 = new WeakMap(), _a16);
...
var _a17, _current, _options, _frames2, _channel, _listenerController, _clientPromise, _keepAliveInterval, _stoppedAt, __ServiceWorkerSource_instances, startWorker_fn, handleRequest_fn2, handleResponse_fn2, _defaultFindWorker, checkWorkerIntegrity_fn, printStartMessage_fn, printStopMessage_fn;
var ServiceWorkerSource = (_a17 = class extends NetworkSource {
  constructor(options) {
    super();
  ...
  static async from(options) {
    if (__privateGet(_a17, _current) == null) {
      __privateSet(_a17, _current, new _a17(options));
    } else if (shouldInvalidateWorker(__privateGet(__privateGet(_a17, _current), _options), options)) {
      await __privateGet(_a17, _current).terminate();
      __privateSet(_a17, _current, new _a17(options));
    }
    return __privateGet(_a17, _current);
  }
  async enable() {
  ...
  disable() {
    ...
    (_a22 = __privateGet(this, _listenerController)) == null ? void 0 : _a22.abort();
  ...
  async terminate() {
    ...
    if (__privateGet(_a17, _current) === this) {
      __privateSet(_a17, _current, void 0);
    }
  }
  ...
  if (worker == null) {
    const missingWorkerMessage = ((_a22 = __privateGet(this, _options)) == null ? void 0 : _a22.findWorker) ? devUtils.formatMessage(
...
Please consider using a custom "serviceWorker.url" option to point to the actual worker script location, or a custom "findWorker" option to resolve the Service Worker registration manually. More details: https://mswjs.io/docs/api/setup-worker/start`,
  ...
  if ((_a22 = response.type) == null ? void 0 : _a22.includes("opaque")) {
...
}, __privateAdd(_a17, _current), _a17);
var _event, _ServiceWorkerHttpNetworkFrame_instances, respondWith_fn, _a18;
var ServiceWorkerHttpNetworkFrame = (_a18 = class extends HttpNetworkFrame {
  constructor(options) {
...
async function handleRequest(options) {
  ...
  const onAbort = () => {
    var _a23;
    requestAbortPromise.reject((_a23 = options.request.signal) == null ? void 0 : _a23.reason);
  };
  ...
  (_a22 = options.request.signal) == null ? void 0 : _a22.removeEventListener("abort", onAbort);
...
var _a19;
var FetchInterceptor = (_a19 = class extends Interceptor2 {
  constructor() {
    super(_a19.symbol);
  }
  checkEnvironment() {
...
}, _a19.symbol = Symbol.for("fetch-interceptor"), _a19);
      ...
      methodCall: ([methodName, args], invoke) => {
        switch (methodName) {
          ...
          case "send": {
            ...
            queueMicrotask(() => {
              var _a22;
              (((_a22 = this.onRequest) == null ? void 0 : _a22.call(this, {
                request: fetchRequest,
                requestId: this.requestId
...
var _a20;
var XMLHttpRequestInterceptor = (_a20 = class extends Interceptor2 {
  constructor() {
    super(_a20.symbol);
  }
  checkEnvironment() {
...
}, _a20.symbol = Symbol.for("xhr-interceptor"), _a20);
var _FallbackHttpSource_instances, printStartMessage_fn2, printStopMessage_fn2, _a21;
var FallbackHttpSource = (_a21 = class extends InterceptorSource {
  constructor(options) {
    super({
  ...
  return {
    async start(options) {
      ...
      const httpSource = supportsServiceWorker() ? await ServiceWorkerSource.from({
        serviceWorker: {
          url: ((_b2 = (_a22 = options == null ? void 0 : options.serviceWorker) == null ? void 0 : _a22.url) == null ? void 0 : _b2.toString()) || DEFAULT_WORKER_URL,
